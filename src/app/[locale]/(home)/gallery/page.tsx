      ...
      <div className="absolute inset-x-0  bg-blue-gray-900/40 h-full bottom-0  flex justify-center ">
        <div className="w-11/12 flex flex-col items-center ">
          <div className="w-11/12 h-full flex flex-col items-center  justify-end  pr-10  ">
            <p className="text-lg sm:text-[0.54rem] md:text-[12px] lg:text-[15px] xl:text-[12px] 2xl:text-[17px] font-bold object-bottom ">
              {title}
            </p>
            <div className="w-10/12  flex flex-col items-center  justify-end ">
              <p className=" text-[0.70rem]  sm:text-[0.43rem] md:text-[0.53rem]   xl:text-[0.53rem] lg:text-[0.65rem] 2xl:text-xs  font-normal ">{subtitle}</p>

              <div className=" absolute pl-[295px] sm:pl-[200px]  md:pl-[250px]  xl:pl-[190px] lg:pl-[260px] 2xl:pl-80">
                <svg
                  width="49"
                  height="50"
                  viewBox="0 0 91 79"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className=" flex justify-between sm:w-8  md:w-12  xl:w-9  w-5/6 "
                >
                  <path
