      ...
      <section className="flex justify-center py-10">
        <div className="w-10/12 flex items-center gap-10">
          <Image
            ...
            alt={""}
            className=" rounded-s-3xl object-cover h-full w-6/12 hidden xl:block"
          />
          <form
          ...
          >
            <div>
              <h1 className="text-4xl font-extrabold">{t("services.formTitle")}</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <div className="w-full flex flex-col gap-2">
                <div className="font-bold text-xl">{t("services.Select")}</div>
            ...
            <div className="w-full flex flex-col gap-2">
              <div className="font-bold text-xl">{t("services.Message")}</div>
              <Textarea
                labelProps={{
                  className: "before:content-none after:content-none",
                }}
