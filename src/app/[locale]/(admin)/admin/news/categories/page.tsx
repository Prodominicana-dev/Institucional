...
import Card from "@/components/admin/news/category/card";
import { NewsCategoriesDialog } from "@/components/admin/news/category/dialog";
...
export default function Page() {
  ...
  const [categories, setDirections] = useState([]);
              ...
              <div className="w-11/12 flex flex-col space-y-4">
                ...
                <div className="w-full  space-y-5 text-black">
                  <>
                    ...
                    {currentCategories?.map((direction: any, key: number) => {
                      return (
                        <Card
                          key={key}
                          category={direction}
