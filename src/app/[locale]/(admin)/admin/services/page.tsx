...
import { useServices } from "@/services/service/service";
import Card from "@/components/admin/service/card";
                ...
                <div className="w-full  space-y-5 text-black">
                  <>
                    <div className="grid items-center justify-between w-full h-24 grid-cols-2 lg:grid-cols-4 p-5 font-bold text-center bg-white rounded-lg ring-2 ring-gray-100">
                      ...
                      <div className="text-center hidden lg:block">Tipo</div>
                      <div>Acción</div>
                    </div>

                    {currentMembers?.map((service: any, key: number) => {
                      return (
                        <Card
                          key={key}
                          service={service}
