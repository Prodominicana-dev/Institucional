...
import { ProductDialog } from "@/components/admin/export/products/dialog";
import Card from "@/components/admin/export/products/card";
...
export default function Page() {
  ...
  const currentMembers = products?.slice(indexOfFirst, indexOfLast);
              ...
              <div className="w-11/12 flex flex-col space-y-4">
                ...
                <div className="w-full  space-y-5 text-black">
                  <>
                    ...
                    {currentMembers?.map((product: any, key: number) => {
                      return (
                        <Card
                          key={key}
                          product={product}
