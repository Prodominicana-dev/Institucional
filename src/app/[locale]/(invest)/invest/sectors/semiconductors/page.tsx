...
export default function Page() {
  const t = useTranslations("invest.sectors.list.4");
    ...
    subSectors: [
      {
        ...
        icon: "/svg/invest/subsectors/subsectorIcon9.svg",
      },
      {
        name: t("subsectors.1.name"),
        icon: "/svg/invest/subsectors/subsectorIcon10.svg",
      },
      {
        name: t("subsectors.2.name"),
        icon: "/svg/invest/subsectors/subsectorIcon11.svg",
      },
    ],
    incentives: {
