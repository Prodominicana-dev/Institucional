...
export default function Page() {
  const t = useTranslations("invest.sectors.list.8");
  ...
  const TourismSector = {
    ...
    video: "/videos/invest/realstate.mp4",
    icon: "/svg/invest/sectors/realestateIcon.svg",
    subSectors: [
      {
        name: t("subsectors.0.name"),
        icon: "/svg/invest/subsectors/subsectorIcon23.svg",
      },
      {
        name: t("subsectors.1.name"),
        icon: "/svg/invest/subsectors/subsectorIcon24.svg",
      },
      {
        name: t("subsectors.2.name"),
        icon: "/svg/invest/subsectors/subsectorIcon25.svg",
      },
      {
        name: t("subsectors.3.name"),
        icon: "/svg/invest/subsectors/subsectorIcon26.svg",
      },
    ],
    incentives: {
