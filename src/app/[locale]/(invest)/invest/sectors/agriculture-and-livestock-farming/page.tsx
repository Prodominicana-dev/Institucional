...
export default function Page() {
  const t = useTranslations("invest.sectors.list.5");
    ...
    subSectors: [
      {
        ...
        icon: "/svg/invest/subsectors/subsectorIcon19.svg",
      },
      {
        name: t("subsectors.1.name"),
        icon: "/svg/invest/subsectors/subsectorIcon20.svg",
      },
      {
        name: t("subsectors.2.name"),
        icon: "/svg/invest/subsectors/subsectorIcon21.svg",
      },
    ],
    incentives: {
