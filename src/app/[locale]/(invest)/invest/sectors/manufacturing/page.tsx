...
export default function Page() {
  const t = useTranslations("invest.sectors.list.3");
    ...
    subSectors: [
      {
        ...
        icon: "/svg/invest/subsectors/subsectorIcon15.svg",
      },
      {
        name: t("subsectors.1.name"),
        icon: "/svg/invest/subsectors/subsectorIcon16.svg",
      },
      {
        name: t("subsectors.2.name"),
        icon: "/svg/invest/subsectors/subsectorIcon17.svg",
      },
      {
        name: t("subsectors.3.name"),
        icon: "/svg/invest/subsectors/subsectorIcon18.svg",
      },
    ],
    incentives: {
