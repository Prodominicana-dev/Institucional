    ...
    <div className=' hidden lg:flex w-full h-full bg-blue-dark flex-col gap-2 rounded-lg items-center p-5'>
        ...
        {sections.map((section: any, index) => (
            <div key={index} className='w-full flex justify-center'>
                {section.type === 'url' && <SidebarLink  title={section.name} link={section.url} />}
                {section.type === '' && <SidebarMenu title={section.name} subsections={section.subsection} id={section.id} /> }
