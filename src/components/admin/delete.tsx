        ...
        >
          <div className="flex flex-col items-center justify-center p-3 space-y-12">
            ...
            <div className="flex flex-row w-full space-x-3">
              <button
                className="w-full h-12 font-normal text-red-500 duration-300 bg-white rounded-lg hover:shadow-lg hover:text-white hover:bg-red-500 border-2 border-red-500  "
                onClick={funct}
              >
                Eliminar
              </button>
