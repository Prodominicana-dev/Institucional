            ...
            <div className="w-full flex gap-4">
              ...
              <div className="flex flex-col gap-2 w-6/12">
                <div className="w-full">
                  ...
                  <Autocomplete
                    onChange={setSpanishCategory}
                    label="Categoría"
                    options={spanishCategories}
                    value={spanishCategory}
                    className="w-full h-10 ring-1 ring-gray-300 rounded-lg  focus:ring-blue-dark focus:outline-none focus:ring-2 duration-300 text-black text-base  p-2"
                  />
                </div>
                <label
                  className={`${
            ...
            <div className="w-full flex gap-4">
              ...
              <div className="flex flex-col gap-2 w-6/12">
                <div>
                  ...
                  <Select
                    defaultValue={englishCategories.map((opt: any) => {
                      opt.value === englishCategory;
                    })}
                    onChange={(e: any) => {
                      setEnglishCategory(e?.value as string);
                      console.log(e?.value as string);
                    }}
                    options={englishCategories}
                  />
                </div>
                <label
                  className={`${
