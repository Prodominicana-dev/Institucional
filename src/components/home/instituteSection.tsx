  ...
  return (
    <section className="w-full sm:h-[20vh] bg-blue-950 flex flex-col sm:flex-row justify-center items-center space-y-5 sm:space-y-0 sm:space-x-10 text-center p-5 lg:p-0">
      <div className="flex flex-col justify-center items-center">
        <Typography
          className="sm:text-lg lg:text-4xl uppercase text-cyan-600 font-bold font-montserrat"
          placeholder={undefined}
        >
          {t("title")}
        </Typography>
        <Typography
          className="text-medium lg:text-xl uppercase text-white font-montserrat font-medium"
          placeholder={undefined}
        >
          {t("description")}
        </Typography>
      ...
      <Button
        placeholder={undefined}
        className="h-14 px-10 bg-red-700 rounded-full text-xl hover:text-white/60 duration-300 font-gotham"
      >
        {t("buttonText")}
      </Button>
    </section>
