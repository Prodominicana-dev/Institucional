...
export default function Breadcrumb() {
  ...
  return (
    ...
    <Link href="/" className="opacity-60  hover:text-blue-900 transition-colors">
      <svg
    ...
    <div className="opacity-60  hover:text-blue-900 transition-colors cursor-pointer"> Inicio</div>
   {
       ...
       const href = `/${ruteName.slice(0, index + 1).join('/')}`;
         ...
         return (
           <span key={href} className="flex items-center">
              ...
              <Link href={href} className=" opacity-60 hover:text-blue-900 transition-colors -translate-x-2 ">
                {`${routesName}`  }
              </Link>
           </span>
         );
